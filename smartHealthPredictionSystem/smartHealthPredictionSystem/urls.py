...
urlpatterns = [
    ...
    path('delete_prediction_admin<int:pid>', views.delete_prediction_admin, name="delete_prediction_admin"),
    ...
    path('delete_prediction_doc<int:pid>', views.delete_prediction_doc, name="delete_prediction_doc"),
    ...
    path('delete_prediction<int:pid>', views.delete_prediction, name="delete_prediction"),
