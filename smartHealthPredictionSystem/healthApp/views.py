...
def PatientHealthPredictionPage(request):
    ...
    if request.method=="POST":
        ...
        PredictionData.objects.create(patient=patient, prediction_accuracy=round(accuracy_score(test_Y, final_preds)*100,2), result=predictionDetails["Final Prediction"], values_list=listDiseases, predict_for="General Health Prediction")
        # print(listDiseases)
